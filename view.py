...
with graph.as_default():    
    ...
    def load_model():
        sess.run(init_op)
        saver = tf.train.import_meta_graph('E:/FRAS_production/Simulation/FRAS_20170726/FRAS_20170727.meta')
        print('The model is loading...')
        saver.restore(sess, "E:/FRAS_production/Simulation/FRAS_20170726/FRAS_20170727")
        print('loaded...')
        pass
    ...
    def auto_setup():
        ...
        selection_2=Shooting_Session.query.filter(Shooting_Session.date==curdate).all()
    ...
    def group_gen():
        ...
        da_7=None
        da_8=None
        print("This is inside gen",file=sys.stderr)
    ...
    def generate_ref():
        ...
        if request.method == "POST":
            ...
            if (paper_ref == 'New'):
                print("Inside New",file=sys.stderr)
                g=0              
            else:
    ...
    def save_target_1():
        ...
        try:
            if request.method == 'POST':
                     ...
                     print(temp_shooting,file=sys.stderr)
                     if(temp_shooting is None):
                         print("Inside If",file=sys.stderr)
                         print(ref_1,file=sys.stderr)
    ...
    def load ():
        try:
            print("Inside ref",file=sys.stderr)
            ref_1=None
            print("Inside load 1",file=sys.stderr)
            if request.method == 'POST':
                print("Inside load 2",file=sys.stderr)
                detail_no = request.form['game_id_1']            
                tmp_list = []
                duplicate = False
                r=request.form['tag']
                ...
                print("Inside ref _3",file=sys.stderr)
                if ref == None or ref =="":
                    print("Inside if",file=sys.stderr)
                    ...
                    print("Inside ref _4 else",file=sys.stderr)
                    ref_1=ref
                    print(ref_1,file=sys.stderr)
                    
                    print("Inside ref _4 else 1",file=sys.stderr)
                    if(int(set_no)>5):
                        print("Inside ref _5 else",file=sys.stderr)
                        return redirect(url_for('paper_duplicate_error'))
                    
                    else:
                        print("Inside TPaper_ref",file=sys.stderr)
                        db.session.query(TPaper_ref).delete()
                        print("Inside TPaper_ref",file=sys.stderr)
                        db.session.commit()
                ...
                print("Inside load 3",file=sys.stderr)
                ...
                if(duplicate):
                    ...
                    print(temp,file=sys.stderr)
                    if(temp is None):
                        print("Inside the temp if",file=sys.stderr)
                        print(sess,file=sys.stderr)
                        print(detail_no,file=sys.stderr)
                        Tdetail_shots =TShooting(
                                        date=datetime.datetime.now(),
                                        datetimestamp=time.strftime("%Y-%m-%d %H:%M"),
                                        session_id=sess,
                        ...
                        print(Tdetail_shots,file=sys.stderr)
                        print("Tdetail_shots",file=sys.stderr)
                        db.session.add(Tdetail_shots)
                        db.session.commit()
    ...
    def load_1 ():
        ...
        try:
            if request.method == 'POST':
                print("This is inside Post",file=sys.stderr)
                
                detail_no = request.form['game_id_1']  
                print("this is detail_no",file=sys.stderr)
                print(detail_no,file=sys.stderr)
                tmp_list = []
                duplicate = False
                ...
                print(tmp_list,file=sys.stderr)
             ...
             print(e,file=sys.stderr)
             return redirect(url_for('error_31'))
    ...
    def view_detail_edit(id):
        ...
        if form.validate_on_submit():
            tmp_list = []
            target_1=Shooter.query.filter(Shooter.name==form.target_1.data ,Shooter.service_id == form.target_1_service.data).scalar()
            tmp_list.append(target_1.id)
            target_2=Shooter.query.filter(Shooter.name==form.target_2.data ,Shooter.service_id == form.target_2_service.data).scalar()
            tmp_list.append(target_2.id)
            target_3=Shooter.query.filter(Shooter.name==form.target_3.data ,Shooter.service_id == form.target_3_service.data).scalar()
            tmp_list.append(target_3.id)
            target_4=Shooter.query.filter(Shooter.name==form.target_4.data ,Shooter.service_id == form.target_4_service.data).scalar()
            tmp_list.append(target_4.id)
            target_5=Shooter.query.filter(Shooter.name==form.target_5.data ,Shooter.service_id == form.target_5_service.data).scalar()
            tmp_list.append(target_5.id)
            target_6=Shooter.query.filter(Shooter.name==form.target_6.data ,Shooter.service_id == form.target_6_service.data).scalar()
            tmp_list.append(target_6.id)
            target_7=Shooter.query.filter(Shooter.name==form.target_7.data ,Shooter.service_id == form.target_7_service.data).scalar()
            tmp_list.append(target_7.id)
            target_8=Shooter.query.filter(Shooter.name==form.target_8.data ,Shooter.service_id == form.target_8_service.data).scalar()
            ...
            if(duplicate):
                ...
                target_1_obj=Shooter.query.filter(Shooter.name==form.target_1.data ,Shooter.service_id == form.target_1_service.data).scalar()
                detail.target_1_id=target_1_obj.id
                target_2_obj=Shooter.query.filter(Shooter.name==form.target_2.data ,Shooter.service_id == form.target_2_service.data).scalar()
                detail.target_2_id=target_2_obj.id
                target_3_obj=Shooter.query.filter(Shooter.name==form.target_3.data ,Shooter.service_id == form.target_3_service.data).scalar()
                detail.target_3_id=target_3_obj.id
                target_4_obj=Shooter.query.filter(Shooter.name==form.target_4.data ,Shooter.service_id == form.target_4_service.data).scalar()
                detail.target_4_id=target_4_obj.id
                target_5_obj=Shooter.query.filter(Shooter.name==form.target_5.data ,Shooter.service_id == form.target_5_service.data).scalar()
                detail.target_5_id=target_5_obj.id
                target_6_obj=Shooter.query.filter(Shooter.name==form.target_6.data ,Shooter.service_id == form.target_6_service.data).scalar()
                detail.target_6_id=target_6_obj.id
                target_7_obj=Shooter.query.filter(Shooter.name==form.target_7.data ,Shooter.service_id == form.target_7_service.data).scalar()
                detail.target_7_id=target_7_obj.id
                target_8_obj=Shooter.query.filter(Shooter.name==form.target_8.data ,Shooter.service_id == form.target_8_service.data).scalar()
    ...
    def upload():
        try:
            print("hello up",file=sys.stderr)
            ...
            if form.is_submitted():
                ...
                for i in range(len(lis)):
                    if (i==0):
                        ...
                        print(shooters,file=sys.stderr)
    ...
    def group_detail_edit(id):
         ...
         if form.validate_on_submit():
             print("Hello inside submit",file=sys.stderr)
    ...
    def session_setup():
        try:
            ...
            form=SessionForm()
            print(rang_name,file=sys.stderr)
    ...
    def individual_score_target_1():
        ...
        if(data is None):
            ...
            firer_id =data.target_1_id
            detail_no =data.detail_no
            print("firer_id",file=sys.stderr)
            print(firer_id,file=sys.stderr)
            session_no =data.session_id
            target_no = 1
            ...
            shooter=Shooter.query.filter(Shooter.id==firer_id).scalar()
            print("shooter",file=sys.stderr)
            print(shooter,file=sys.stderr)
            service_id = shooter.service_id
            
            rank_id=shooter.rank_id
    ...
    def prediction_target_1():
        ...
        if request.method == 'POST':
            ...
            set_2_x=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 ,T_Firer_Details.set_no==2 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            set_2_y=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==2 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            ...
            set_3_x=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==3 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            set_3_y=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==3 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            ...
            print(set_3_x_arr,file=sys.stderr)   
            set_4_x=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==4 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            set_4_y=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==4 ,T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess).all()
            ...
            print("set_2_detail_no",file=sys.stderr)
            print(set_2_detail_no,file=sys.stderr)
            print(set_2_detail_no,file=sys.stderr)
    ...
    def previous_page_target_1():
        ...
        print(T1_rank,file=sys.stderr)
        print(T2_rank,file=sys.stderr)
        print(T3_rank,file=sys.stderr)
        print(T4_rank,file=sys.stderr)
    ...
    def prediction_calculation_1():
        ...
        paper_ref=db.session.query(TPaper_ref.paper_ref).scalar()
        print(paper_ref ,file=sys.stderr)
        data_x_1=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==1 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess_id).all()
        data_y_1=db.session.query(T_Firer_Details).filter(T_Firer_Details.date==curdate , T_Firer_Details.target_no==1 , T_Firer_Details.set_no==1 , T_Firer_Details.paper_ref==paper_ref , T_Firer_Details.session_id==sess_id).all()
        ...
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/1.png')
        w,h = image.size
    ...
    def prediction_calculation_2():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/2.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_3():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/3.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_4():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/4.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_5():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/5.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_6():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/6.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_7():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/7.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def prediction_calculation_8():
        ...
        print('Old x' ,file=sys.stderr)
        print(data_x_1,file=sys.stderr)
        image=Image.open('E:/FRAS_production/static/img_dump/8.png')
        w,h = image.size
        predictedMatrix = predictAsMatrix(image,w,h)
        g= Graph(80, 80, predictedMatrix)
        N=g.countIslands()
    ...
    def save_call_1():
        print("this is save_call_1",file=sys.stdout)
        final_x=[]
        final_y=[]
        tend_f_x_t = None
        tend_f_y_t = None
        ...
        if request.method == 'POST':
            ...
            update=db.session.query(TShooting).scalar()
            update.save_flag=1
            db.session.commit()
            print("t1",file=sys.stderr)
            print(t1,file=sys.stderr)
    ...
    def save_image_1(firer_id):
        srcfile = 'E:/FRAS_production/static/img_dump/1.png'
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "1.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
        newfilename+=".png"
        new_file = os.path.join("E:/FRAS_production/static/image_db/", newfilename)
        os.rename(old_file, new_file)
        return newfilename
    
    def save_image_2(firer_id):
        srcfile = 'E:/FRAS_production/static/img_dump/2.png'
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "2.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
        ...
        new_file = os.path.join("E:/FRAS_production/static/image_db/", newfilename)
        os.rename(old_file, new_file)
        os.remove("E:/FRAS_production/static/img_dump/2.png")
        os.remove("E:/FRAS_production/static/img_dump/2.jpg")
        return newfilename
    ...
    def save_image_3(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "3.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def save_image_4(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "4.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def save_image_5(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "5.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def save_image_6(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "6.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def save_image_7(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "7.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def save_image_8(firer_id):
        ...
        dstdir = 'E:/FRAS_production/static/image_db/'
        shutil.copy(srcfile, dstdir)     
        old_file = os.path.join("E:/FRAS_production/static/image_db/", "8.png")
        newfilename=""
        newfilename+=str(firer_id)
        newfilename+="_"
        newfilename+=time.strftime("%Y_%m_%d_%H_%M")
    ...
    def savempi_db(detail_no,target_no,paper_no,firer_id,firt_x,firt_y,tendency,session_id,set_no,tend_f,tend_f_x ,tend_f_y,tend_f_x_1,tend_f_y_1):
        try:
            print("this is firt_x",file=sys.stderr)
    ...
    def crop_data_1():
        img = Image.open("E:\\FRAS_production\\static\\raw_image\\CAMERA1_1.JPG")
        if request.method == "POST":
            data=request.get_json()
            ...
            resize_image.save('E:\\FRAS_production\\static\\img_dump\\1.jpg', 'JPEG')
            image_png=Image.open("E:\\FRAS_production\\static\\img_dump\\1.jpg")
            #os.remove("E:/FRAS_production/static/img_dump/1.png")
            image_png.save("E:\\FRAS_production\\static\\img_dump\\1.png")
    ...
    def calibration_2():
        ...
        x2=data.x2
        y2=data.y2
        img = Image.open("E:\\FRAS_production\\static\\raw_image\\CAMERA2_2.JPG")
        img2 = img.crop((x1, y1, x2, y2))
        resize_image=img2.resize((2000, 2000), Image.ANTIALIAS)
        resize_image.save('E:\\FRAS_production\\static\\img_dump\\2.jpg', 'JPEG')
        image_png=Image.open("E:\\FRAS_production\\static\\img_dump\\2.jpg") 
        image_png.save("E:\\FRAS_production\\static\\img_dump\\2.png")
        return redirect(url_for('previous_page_edit_1'))
    ...
    def crop_data_2():
        ...
        if request.method == "POST":
            ...
            #os.remove("E:/FRAS_production/static/img_dump/1.png")
            image_png.save("E:\\FRAS_production\\static\\img_dump\\2.png")
            sth = db.session.query(Crop).filter(Crop.target_no==2).scalar()
            if sth  is None:
                crop =Crop(
                        target_no=2,
                        x1=x1,
                ...
                db.session.query(Crop).filter(Crop.target_no==2).delete()
                db.session.commit()
                crop =Crop(
                        target_no=2,
                        x1=x1,
    ...
    def montly_session_summary():
        ...
        if request.method == 'POST':
            ...
            print("---------",file=sys.stderr)
            print(table_box,file=sys.stderr)    
    ...
    def session_summary():
        ...
        print("---------",file=sys.stderr)
        print(table_box,file=sys.stderr)
        print(distinct_detail_num_arr,file=sys.stderr)
